...
const createReport = asyncHandler(async (req, res) => {
    try {
        // Ensure `user` and `createdById` are ObjectIds
        req.body.user = new mongoose.Types.ObjectId(req.body.user);
        req.body.createdById = new mongoose.Types.ObjectId(req.body.createdById);
        ...
        console.error("Error creating report:", error); // Debugging
...
const updateReport = asyncHandler(async (req, res) => {
    ...
    try {
        ...
        await ActivityLog.create({
            ...
            user: updatedReport?.PostedByuserId || req.user?._id,
...
const deleteReport = asyncHandler(async (req, res) => {
    ...
    try {
        ...
        await ActivityLog.create({
            ...
            user: deletedReport?.PostedByuserId || req.user?._id,
